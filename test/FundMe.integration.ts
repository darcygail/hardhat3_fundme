...
describe("FundMe Integration Test", async function () {
    ...
    it("Should complete full flow: deploy -> fund -> withdraw", async function () {
        ...
        assert.equal(donation, fundAmount, "Donation amount should be recorded correctly");
        ...
        console.log(`✅ Total donation: ${totalDonation / BigInt(1e18)} ETH (0.15 ETH)`);
        ...
        assert(ownerBalanceAfter > ownerBalanceBefore, "Owner balance should increase");
        console.log(
